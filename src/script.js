...
camera.position.y = 5
camera.position.z = 3
gui.add(camera.position,'x').min(-0.5).max(10).step(0.01)
gui.add(camera.position,'y').min(-0.5).max(10).step(0.01)
gui.add(camera.position,'z').min(-0.5).max(10).step(0.01)
scene.add(camera)
